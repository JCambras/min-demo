...
//
// Note: This uses edge runtime (no Node crypto), so CSRF validation
// is a simple string comparison. The timing-safe comparison in csrf.ts
// is used server-side in route handlers if needed.
