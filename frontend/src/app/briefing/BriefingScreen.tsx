...
import { Search, Loader2, User, FileText, Shield, Clock, AlertTriangle, CheckCircle, ExternalLink, ChevronRight, PieChart } from "lucide-react";
            ...
            {s.step === "briefing" && s.intel && (
              <div className="animate-fade-in space-y-5" data-tour="briefing-summary">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  {/* Portfolio Summary — Integration Placeholder */}
                  <div className="bg-white border border-slate-200 rounded-2xl p-5 opacity-60">
                    <p className="text-xs uppercase tracking-wider text-slate-300 mb-3">
                      <PieChart size={12} className="inline mr-1" /> Portfolio
                    </p>
                    <div className="text-center py-3">
                      <PieChart size={24} className="mx-auto text-slate-200 mb-2" />
                      <p className="text-xs text-slate-400 font-medium">Portfolio integration coming soon</p>
                      <p className="text-[10px] text-slate-300 mt-1">Black Diamond, Orion, or custodian feed</p>
                    </div>
                  </div>
