              ...
              <div className="animate-fade-in space-y-6">
                ...
                {filtered.length === 0 && !showAdd && (
                  <div className="bg-white border border-slate-200 rounded-2xl p-12 text-center">
                    ...
                    <p className="text-slate-600 font-medium mb-1">No goals yet</p>
                    <p className="text-sm text-slate-400 mb-4">Add financial planning goals and milestones to track client progress.</p>
